...
Hike.create(user_id: sally.id, mountain_id: baldy.id, rating: 5, comment: "So fun I'll do it again", date_hiked: "2014-04-20", percent_hiked: 100, hiked: true)
