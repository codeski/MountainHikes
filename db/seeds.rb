...
Hike.create(user_id: sally.id, mountain_id: quandry.id, rating: 4, comment: "My knees hurt", date_hiked: "2016-05-20", percent_hiked: 100)
Hike.create(user_id: sally.id, mountain_id: baldy.id, rating: 5, comment: "So fun will do it again", date_hiked: "2014-04-20", percent_hiked: 100)
Hike.create(user_id: sally.id, mountain_id: baldy.id, rating: 3, comment: "So busy, the secret is out", date_hiked: "2018-09-20", percent_hiked: 75)
Hike.create(user_id: fred.id, mountain_id: quandry.id, rating: 2, comment: "Oxygen is way too thin", date_hiked: "2012-07-20", percent_hiked: 75)
Hike.create(user_id: fred.id, mountain_id: buck.id, rating: 5, comment: "Took me 20 minutest to hike", date_hiked: "2006-08-20", percent_hiked: 75)
Link.create(user_id: fred.id, mountain_id: baldy.id)
Link.create(user_id: fred.id, mountain_id: peak1.id)